...
export default class RideScreen extends Component {
  ...
  getCameraPermissions = async () => {
    const { status } = await Camera.requestCameraPermissionsAsync();//Permissions.askAsync(Permissions.CAMERA);
  ...
  handleTransaction = () => {
    ...
    db.collection("bicycles")
      ...
      .then(doc => {
        var bike = doc.data();
        if (bike.is_bike_avaliable) {
          this.assignBike();
        } else {
          this.returnBike();//initiateBookReturn();
        }
      });
  };
